...
export default function CartPopup(props){
  ...
  return (
    <section ref={popupRef} className="absolute right-0 -translate-x-20 -translate-y-5 w-80 h-45 rounded-lg bg-white shadow-xl">
      ...
      <div className="px-5 py-3 text-dark-grayish-blue font-semibold text-sm">
        {!props.productAttri.selected && <p>The cart is empty</p>}
        ...
        {props.productAttri.selected && <>
          <div className="flex items-center justify-between">
            ...
            <div className="text-dark-grayish-blue/80 font-medium capitalize">
              ...
              <p>$125.00 x 1 <span className="text-very-dark-blue font-bold">$125.00</span></p>
            </div>

            <button className="cursor-pointer fill-[#C3CAD9] hover:fill-very-dark-blue">
          ...
          <button className="w-full bg-orange hover:bg-orange/60 text-sm font-semibold text-very-dark-blue py-2.5 rounded-md mt-3.5">
            Checkout
          </button>
        </>}
      </div>
