export default function RightContainer({productAttri, setIsCartOpen, setProductAttri}){
  ...
  return (
    <div className="px-6 sm:px-0">
      ...
      <h1 className='font-bold text-very-dark-blue capitalize text-3xl sm:text-4xl mb-4 sm:mb-6'>Fall limited edition sneakers</h1>
      ...
      <div className="flex justify-between sm:block">
        <div className="">
          <p className='text-very-dark-blue text-2xl sm:text-xl font-bold inline-block me-3 mb-1.5'>$125.00</p>
          <button className='px-2 py-1 bg-very-dark-blue font-semibold rounded-md text-white text-sm sm:text-xs'>50%</button>
        </div>
        <p className='text-base sm:text-sm font-semibold text-dark-grayish-blue line-through mb-6 inline-block sm:block'>$250.00</p>
      </div>

      <div className="sm:grid grid-cols-[35%_auto] gap-3 space-y-4 sm:space-y-0">
        <div className="flex bg-light-grayish-blue rounded-md px-3 h-12 sm:h-auto">
        ...
        <button onClick={handleClick}
          className='text-sm font-semibold text-very-dark-blue bg-orange hover:bg-orange/60 h-12 sm:h-auto
