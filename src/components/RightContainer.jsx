    ...
    <div className="">
      ...
      <div className="grid grid-cols-[35%_auto] gap-3">
        <div className="flex bg-light-grayish-blue rounded-md px-3">
          ...
          <input type='text' disabled value={0} className='w-full text-center text-sm text-very-dark-blue font-semibold' />
        ...
        <button className='text-sm font-semibold text-very-dark-blue bg-orange hover:bg-orange/60 cursor-pointer w-full rounded-md py-2.5 flex items-center justify-center gap-3'>
